  ...
  return (
    <div className="policy-content">
      ...
      <p className="text-gray-700 mb-4">
        This Cookie Policy explains how SunsetView.com ("we", "us", or "our")
        uses cookies and similar technologies on our website. This policy is
        part of our Privacy Policy and should be read alongside our Terms of
        Service.
      </p>
      ...
      <section className="mb-6">
        ...
        <p className="text-gray-700 mb-3">
          ...
          tablet, or mobile) when you visit our website. They allow our website
          to recognize your device and remember certain information about your
          visit, such as your preferences and actions.
        </p>

        <p className="text-gray-700">
          Cookies are widely used to make websites work more efficiently and to
          provide a better browsing experience. They can also provide
          information to the owners of the site about how users interact with
          their website.
        </p>
      </section>
      ...
      <section className="mb-6">
        ...
        <p className="text-gray-700 mb-3">
          ...
          enable basic functions like page navigation, access to secure areas of
          the website, and booking functionality. The website cannot function
        ...
        <p className="text-gray-700 mb-3">
          ...
          website by collecting and reporting information anonymously. They help
          us improve the way our website works by, for example, ensuring that
        ...
        <p className="text-gray-700 mb-3">
          ...
          your preferred language or the region you are in) and provide
          enhanced, more personal features. They may also be used to provide
          services you have asked for, such as watching a video or commenting on
          a blog.
        </p>
      ...
      <section className="mb-6">
            ...
            <tbody>
              <tr>
                ...
                <td className="border border-gray-300 px-4 py-2">
                  Used to maintain your authentication state
                </td>
              ...
              <tr className="bg-gray-50">
                ...
                <td className="border border-gray-300 px-4 py-2">
                  Used to maintain your active session
                </td>
                <td className="border border-gray-300 px-4 py-2">Essential</td>
              ...
              <tr className="bg-gray-50">
                ...
                <td className="border border-gray-300 px-4 py-2">
                  Used to collect anonymous usage data
                </td>
                <td className="border border-gray-300 px-4 py-2">
                  Performance
                </td>
              ...
              <tr>
                ...
                <td className="border border-gray-300 px-4 py-2">
                  Stores your recent search history
                </td>
                <td className="border border-gray-300 px-4 py-2">
                  Functionality
                </td>
        ...
        <p className="text-gray-600 text-sm mt-3">
          This table is not exhaustive and may be updated as we change or add
          new cookies.
        </p>
      </section>
      ...
      <section className="mb-6">
        ...
        <p className="text-gray-700 mb-3">
          ...
          cookies to report usage statistics, deliver advertisements, and so on.
          These cookies may include:
        </p>

        <ul className="list-disc pl-6 space-y-1 text-gray-700">
          <li>
            <strong>Analytics cookies</strong> from services like Google
            Analytics to help us understand how visitors use our site.
          </li>
          <li>
            <strong>Social media cookies</strong> from platforms like Facebook,
            Twitter, and Instagram to enable social sharing functionality.
          </li>
          <li>
            <strong>Advertising cookies</strong> from our advertising partners
            to help deliver more relevant advertisements.
          </li>
          <li>
            <strong>Payment processing cookies</strong> from our payment
            providers to facilitate secure transactions.
          </li>
        </ul>
      </section>
      ...
      <section className="mb-6">
        ...
        <p className="text-gray-700 mb-3">
          You can manage cookie preferences through your browser settings. Here
      ...
      <section className="mb-6">
        ...
        <div className="text-gray-700">
          <p>SunsetView.com</p>
          <p>Leicester, Leicestershire</p>
          <p>LE1 9BH, United Kingdom</p>
          <p>Email: privacy@sunsetview.com</p>
          <p>Phone: +44 7979 481290</p>
        </div>
      </section>
    </div>
  );
