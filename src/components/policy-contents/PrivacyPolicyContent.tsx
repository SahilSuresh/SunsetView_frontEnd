  ...
  return (
    <div className="policy-content">
      ...
      <p className="text-gray-700 mb-4">
        At SunsetView.com, we respect your privacy and are committed to protecting your personal data. 
      ...
      <section className="mb-6">
        ...
        <p className="text-gray-700 mb-4">
          ...
          phone number, payment information, and other information you choose to provide.
        </p>
        
        <h3 className="font-bold text-gray-800 mb-2">Automatically Collected Information</h3>
        <p className="text-gray-700 mb-3">
      ...
      <section className="mb-6">
        <h2 className="text-xl font-bold text-gray-800 mb-3">Cookies and Tracking Technologies</h2>
      ...
      <section className="mb-6">
        <h2 className="text-xl font-bold text-gray-800 mb-3">Data Sharing and Disclosure</h2>
        
        <p className="text-gray-700 mb-3">
          We may share your personal information with the following parties:
        </p>
        
        <h3 className="font-bold text-gray-800 mb-2">Service Providers</h3>
        <p className="text-gray-700 mb-3">
          We may share your information with third-party service providers who perform services on our behalf, 
          such as payment processing, data analysis, email delivery, hosting services, and customer service.
        </p>
        
        <h3 className="font-bold text-gray-800 mb-2">Hotels and Accommodation Providers</h3>
        <p className="text-gray-700 mb-3">
          To complete your booking, we will share your information with the relevant hotels or accommodation providers.
        </p>
        
        <h3 className="font-bold text-gray-800 mb-2">Legal Requirements</h3>
      ...
      <section className="mb-6">
        ...
        <ul className="list-disc pl-6 space-y-1 text-gray-700">
          ...
          <li><strong>Data Portability:</strong> You can request that we transfer your information to another organization or to you.</li>
