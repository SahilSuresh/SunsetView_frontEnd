    ...
    <div className="max-w-6xl mx-auto px-4 py-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          <h2 className="text-2xl font-bold mb-4 text-orange-600">Send Us a Message</h2>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <button
                ...
                className="bg-gradient-to-r from-orange-300 to-orange-500 text-white py-2 px-6 rounded-full font-bold hover:from-orange-400 hover:to-orange-600 transition-colors shadow-md disabled:opacity-70"
              >
        ...
        <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">support@sunsetview.com</p>
                  <p className="text-gray-600">info@sunsetview.com</p>
                </div>
              </div>
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            <h2 className="text-2xl font-bold mb-4 text-orange-600">Follow Us</h2>
            <p className="text-gray-700 mb-4">
              Stay connected with us on social media for travel inspiration, exclusive deals, and stunning sunset photos.
            </p>
