      ...
      <div className="space-y-8">
        <section>
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <h3 className="font-bold text-gray-800 mt-6 mb-3">Automatically Collected Information</h3>
            <p className="text-gray-700 mb-4">
