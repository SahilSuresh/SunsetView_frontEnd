...
const MyBooking = () => {
  ...
  const confirmCancel = (hotel: HotelType, booking: any) => {
    ...
    const dateRange = `${formatDateForDisplay(checkInDate)} - ${formatDateForDisplay(checkOutDate)}, ${checkOutDate.getFullYear()}`;
    
    // Navigate to contact page with booking information as query parameters
    navigate(`/contact?bookingId=${booking._id}&hotel=${encodeURIComponent(hotel.name)}&date=${encodeURIComponent(dateRange)}`);
                ...
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                  <div className="bg-white rounded-lg p-6 max-w-md mx-4">
                    ...
                    <p className="text-gray-700 mb-6">
                      Are you sure you want to request cancellation for your booking at {hotel.name}? This will take you to our contact form to complete the cancellation request.
                    </p>
